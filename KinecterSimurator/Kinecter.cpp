...
String Kinecter::getSerialMessage()
{
...
String Kinecter::getWiFiMessage()
{
	char c;
	String ret = L"";
...
vector<vector<bool>> Kinecter::getButtonState(vector<vector<bool>> state)
{
